...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            target_fearure_test_df=test_df[target_column_name]

            logging.info("Applying on Preprocessing object on training dataframe and testing dataframe")
            ...
            train_arr=np.c_[
                input_feature_train_arr,np.array(target_fearure_train_df)
            ]
            test_arr=np.c_[
                input_feature_test_arr,np.array(target_fearure_test_df)
            ]
